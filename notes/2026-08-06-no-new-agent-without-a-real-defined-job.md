---
id: 2026-08-06-no-new-agent-without-a-real-defined-job
type: ruling
status: ratified
...
Applies fleet-wide. For example, TYR needed its one job defined before being considered truly born. This keeps the roster lean and prevents role clutter.

## Links

- relates: 2026-08-06-operator-names-every-new-agent-before-birth
- relates: 2026-08-07-fleet-interview-and-audit-governance
