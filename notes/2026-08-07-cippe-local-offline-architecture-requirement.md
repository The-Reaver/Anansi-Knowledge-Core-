---
id: 2026-08-07-cippe-local-offline-architecture-requirement
type: spec
status: ratified
...
Local DB, e.g. SQLite or Postgres+pgvector. Maintenance happens via encrypted USB or direct cable, de-identified learnings only — consistent with the separately-recorded in-person connection method.

## Links

- relates: 2026-08-07-cippe-in-person-connection-method
